...
import { Pagination, Stack, Typography, CircularProgress } from '@mui/material';
...
const MyFavorites: NextPage = () => {
	...
	if (device === 'mobile') {
		return <div>TURBOCAR MY FAVORITES MOBILE</div>;
	} else {
		return (
				...
				<Stack className="favorites-list-box">
					{getFavoritesLoading ? (
						...
						<div className={'no-data'}>
							...
							<p>Error loading favorites: {getFavoritesError.message}</p>
						</div>
					) : myFavorites?.length ? (
